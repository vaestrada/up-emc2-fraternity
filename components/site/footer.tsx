      ...
      <Container className="grid gap-12 py-20 md:grid-cols-3">
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3 text-sm text-[var(--frat-cream)]/70">
            ...
            <li><Link href="/anniversary" className="transition-colors hover:text-[var(--frat-gold-light)]">The 58th Anniversary</Link></li>
            <li><Link href="/quantum-leap" className="transition-colors hover:text-[var(--frat-gold-light)]">Quantum Leap Sports Series</Link></li>
