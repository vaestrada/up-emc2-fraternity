  ...
  return (
    <section className="flex min-h-[100svh] items-center">
      <Container className="max-w-2xl">
        ...
        <h1 className="mt-6 font-display text-[clamp(3rem,10vw,6rem)] leading-none text-[var(--frat-cream)]">404</h1>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-6">
          ...
          <nav className="flex flex-wrap gap-x-5 gap-y-2 text-[14px] text-[var(--frat-cream)]/60">
            {[
              ...
              <Link key={l.href} href={l.href} className="transition-colors hover:text-[var(--frat-cream)]">
                {l.label}
              </Link>
            ))}
          </nav>
